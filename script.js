...
//<!-- -----------------------Contact Form Database JavaScript code----------------------------- -->
 ...
 var typed = new Typed('.typing', {
    strings: ["Me", "George!", "An App Developer", "A Content Creator", "A Coding Instructor", "A Youtuber", "A Graphic Designer", "A Freelancer", "An ICT Consultant", "A Website Designer", "A  Web3.0 Developer", "George!", "Sir_George", "Mr. George"],
    backSpeed: 100,
    typeSpeed: 70,
    //smartBackspace: true,
    loop: true,
